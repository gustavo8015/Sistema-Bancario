...
class Transaccion:
    ...
    cuenta: str
    monto: float
    tipo: str                 # RETIRO o CONSIGNACION
    origen: str               # cajero que la genero
    estado: str = "PENDIENTE"  # APROBADA / RECHAZADA / CANCELADA

    def delta(self):
        """Cuanto cambia el saldo: negativo si es retiro, positivo si es consignacion."""
        return self.monto if self.tipo == "CONSIGNACION" else -self.monto
...
class NodoReplica:
    ...
    def preparar(self, tx: Transaccion):
        ...
        with self._mutex:
            ...
            if tx.tipo == "RETIRO" and cuenta.saldo < tx.monto:
